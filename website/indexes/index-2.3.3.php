 ...
 */
define('REL_NEW_NUM', '2.3.3pl1');
define('REL_NEW_DATE', '2002-12-04');

define('REL_PREVIOUS_NUM', '2.3.2');
define('REL_PREVIOUS_DATE', '2002-10-08');

define('CVS_VERSION', '2.4.0-dev');

define('MODIF_BY', 'swix'); // link to potm
...
<tr>
    ...
    <td valign="top">
        Welcome on the <i>only</i> official phpMyAdmin project webpage.
    ...
    <!-- More than <b><?php @include("counters/bigcounter"); ?></b> downloads since August 2001! :-) -->
        ...
        <br /><br />
        <font size="-1"><b>2.4.0 release plan:</b> The first release candidate
        for version 2.4.0 is planned for Feb 2nd.</font><br /><br />
        <table>
<?php
if (defined("REL_NEW_NUM")) {
    ?>
        <tr>
            ...
            <font size="-1">This version contains the messages that were
            omitted in some language files.
            </font>
            </td>
        </tr>
        <tr>
...
?>
    ...
    <td valign="top" bgcolor="lightyellow" width="40%">
        <b>Main changes for version 2.3.3:</b>&nbsp;&nbsp;
        (<a href="ChangeLog.txt">ChangeLog</a>)
        <br /><br />

        <font color="red">&nbsp;&nbsp;Improvements:</font>
        <ul>
        <li>upload of compressed dumps</li>
        <li>inform the user who does not have privileges to create a db</li>
        <li>warning if using PHP 4.2.3</li>
        <li>new internal analyzer for db, table, column and alias</li>
        <li>data dictionary report</li>
        <li>warning about blank root password in all auth modes</li>
        </ul>

        <font color="red">&nbsp;&nbsp;Fixes:</font>
        <ul>
        <li>database search and any words</li>
        <li>anonymous user was created as %</li>
        <li>wrong back link after an error</li>
        <li>automatic uppercase causes trouble for some languages</li>
        <li>syntax error for REVOKE</li>
        <li>parsing and INTERVAL</li>
        <li>sorting on a COUNT() column</li>
        <li>no need to check an explicit dot in open_basedir path</li>
        <li>navigation controls not shown with GROUP BY queries</li>
        <li>numeric foreign keys used as aliases</li>
        <li>HTML entities in db or table names</li>
        <li>better dump support for older MySQL</li>
        <li>ignore NULL checkbox if data present</li>
        <li>SHOW INDEXES syntax variant</li>
        <li>USE in query box to change db</li>
        <li>Edit or Delete a row when only an alias is displayed</li>
        <li>Special regexp characters in table name caused bugs</li>
        <li>Reserved words like TABLE in table name caused bugs</li>
        <li>Check referential integrity and NULL foreign key, or
            self-linked table</li>
        <li>inconsistent use of radio buttons on db search page</li>
        <li>export and UTF-8</li>
        <li>auto-increment key does not have to be the primary key</li>
        <li>ANSI comments</li>
        <li>cookie auth and PHP3</li>
        <li>javascript problem for row color pointer </li>
        <li>date column wrap in browse mode</li>
        <li>relations and non-primary key</li>
        <li>sorting a column ORDER BY SUM(var)</li>
        <li>cannot delete a row with a TEXT field containing newlines</li>
        <li>let use a blank password in cookie auth mode</li>
        <li>ORDERing by a function applied to a field</li>
        <li>syntax coloring and UPDATE...SET</li>
        <li>parser and multi-byte characters</li>
        <li>revealing of MySQL connect information if server is down</li>
        <li>bad link to doc of ALTER TABLE</li>
        <li>TEXT field containing HTML is sometimes displayed wrong</li>
        <li>FULLTEXT indexes were not detected correctly with MySQL &gt;= 4.0.2-alpha</li>
        </ul>

 ...
 */
define('REL_NEW_NUM', '2.5.3');
define('REL_NEW_DATE', '2003-09-07');

define('REL_PREVIOUS_NUM', '2.5.2-pl1');
define('REL_PREVIOUS_DATE', '2003-07-30');

define('CVS_VERSION', '2.5.4-dev');
...
?>
        ...
        <li>new language: Azerbaijani</li>
        </ul>
...
<tr>
    ...
    <td valign="top">
        ...
        and is available in <a href="http://www.phpmyadmin.net/documentation/translators.html" target="_blank">44 languages.</a> 
        <br /><br />
        ...
        <tr>
            <td colspan="2">
                <b><font color="red">phpMyAdmin <?php echo REL_NEW_NUM . "\n"; ?></font>
                    (<?php echo REL_NEW_DATE; ?>)</b> <a href="http://www.phpmyadmin.net/<?php echo THIS_SCRIPT; ?>?about=true">Release notes</a><br />
    ...
    ?>
        <tr>
            <td colspan="2">
                ...
                (<?php echo REL_PREVIOUS_DATE; ?>)</b><br />
            </td>
        </tr>
    <?php
